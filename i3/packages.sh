...
utilities=("feh" "gparted" "gnome-disk-utility" "gsmartcontrol" "fastfetch" "nitrogen" "flameshot" "numlockx" "galculator" "cpu-x" "curl" "whois" "progress" "eza" "zoxide" "tree" "btop" "htop" "bat" "light" "brightnessctl" "redshift" "sxhkd")
